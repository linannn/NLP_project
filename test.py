...
train_x = np.column_stack((cos_dis, word_length_diff, word_phase_diff, edit_dis))
# '''
# 测试集
...
test_x = np.column_stack((cos_dis_predit, word_length_diff_predit, word_phase_diff_predit, edit_dis_predit))
